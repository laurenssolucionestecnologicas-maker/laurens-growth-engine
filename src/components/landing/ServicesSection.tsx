...
const ServicesSection = () => {
  ...
  return (
    <section className="py-20 lg:py-28" id="servicios">
      <div className="container">
        ...
        <div className="mt-14 grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div
              key={index}
              className="group relative p-8 bg-card rounded-2xl shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-2 border border-border/50 overflow-hidden"
            >
