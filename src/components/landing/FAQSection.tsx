...
const FAQSection = () => {
  return <section className="py-20 lg:py-28 bg-muted/30" id="faq">
      <div className="container">
        <div className="max-w-3xl mx-auto">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => <AccordionItem key={index} value={`item-${index}`} className="bg-card rounded-xl px-6 border border-border/50 shadow-soft">
